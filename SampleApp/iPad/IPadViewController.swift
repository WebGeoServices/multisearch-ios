...
class IPadViewController: UIViewController {
    ...
    private var  detailsResponseItem: DetailsResponseItem?
    ...
    @IBOutlet weak var btnDetailInfo: UIButton!
    ...
    private func showPinOnMap(_ detailsResponseItem: DetailsResponseItem) {
        self.view.endEditing(true)
        self.detailsResponseItem = detailsResponseItem
        if let geometry = detailsResponseItem.geometry {
            self.googleMapView.isHidden = false
            self.btnDetailInfo.isHidden = false
            let markerLocation = GMSCameraPosition.camera(withLatitude: geometry.location.lat, longitude: geometry.location.lng, zoom: 17)
            self.googleMapView.animate(to: markerLocation)
            ...
            self.btnDetailInfo.isHidden = true
        }
    }
...
extension IPadViewController: UITableViewDelegate, UITableViewDataSource {
...
extension IPadViewController: SearchCellDelegate {
